...
{
    public class SphinxSoundController(IMachine machine, int rate, int outChannels) : SoundControllerCommon(machine, rate, outChannels)
    {
        public override byte MaxMasterVolume => 3;
        public override int NumChannels => 5;

        readonly SoundChannelHyperVoice channelHyperVoice = new();
