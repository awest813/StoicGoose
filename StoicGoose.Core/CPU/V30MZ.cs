...
namespace StoicGoose.Core.CPU
{
    public sealed partial class V30MZ : IComponent
    {
        ...
        {
            /* CPU reset */
            flags = Flags.ReservedB1 | Flags.ReservedB12 | Flags.ReservedB13 | Flags.ReservedB14 | Flags.Mode;
            ip = 0x0000;
            cs = 0xFFFF;
            ds = 0x0000;
            ss = 0x0000;
        ...
        public int Step()
        {
            ...
            /* Ensure correct state of unused flags */
            flags |= Flags.ReservedB1 | Flags.ReservedB12 | Flags.ReservedB13 | Flags.ReservedB14;
            flags &= ~(Flags.ReservedB3 | Flags.ReservedB5);
