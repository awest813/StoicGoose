...
namespace StoicGoose.WinForms
{
    public partial class CheatEditForm : Form
    {
        ...
        readonly string[] cheatConditionNames = ["always", "less than", "less or equal", "greater or equal", "greater than"];
        ...
        public CheatEditForm()
        {
            ...
            cmbCondition.DataSource = Enum.GetValues<CheatCondition>().Select(x => new { Value = x, Description = cheatConditionDescriptive[x] }).ToList();
