...
namespace StoicGoose.GLWindow
{
    public sealed class Configuration : ConfigurationBase<Configuration>
    {
        ...
        public Dictionary<string, string> BootstrapFiles { get; set; } = [];
